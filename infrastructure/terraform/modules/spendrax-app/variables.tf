...
variable "smtp_host" {
  description = "SMTP host exposed to the backend container as a normal environment variable."
  type        = string
  default     = "smtp.gmail.com"
}

variable "smtp_port" {
  description = "SMTP port exposed to the backend container as a normal environment variable."
  type        = number
  default     = 587
}
...
variable "force_delete_ecr_repositories" {
  description = "Force-delete ECR repositories during Terraform destroy, including any images they still contain."
  type        = bool
  default     = true
}
